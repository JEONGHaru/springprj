...
//	
	...
	//게시판 글보기 첨부파일 리스트 - ajax
	@GetMapping(value="/getAttachList", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	public ResponseEntity<List<BoardAttachDTO>> getAttachList(int bno){
		ResponseEntity<List<BoardAttachDTO>> entity = null;
		
		log.info("getAttachList --------------------- : " + bno);
		
		entity = new ResponseEntity<List<BoardAttachDTO>>(service.getAttachList(bno), HttpStatus.OK);
