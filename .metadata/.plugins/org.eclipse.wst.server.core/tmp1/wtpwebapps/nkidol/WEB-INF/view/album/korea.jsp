		...
		<div class="container services">
			<div class="services-header text-center py-5">
				...
				<c:if test="${principal.userGrade == 9 }">
					<form class="row" action="korea/upload?year=${years}&gen=${gender}"
...
<div class="modal fade" id="emailCheckModal" tabindex="-1"
	aria-labelledby="emailCheckModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="btn-close" data-bs-dismiss="modal"
			...
			<div class="modal-body">
				いいねをするためにはE-mailの確認が必要です。<br> 右上のE-MAILボタンを押して確認してください。
			</div>
